...
# It's not working as expected because on line 10, reassign is used instead of comparision
# in 'odd_count = 3' double equals sign should be used
# We can also get rid of ternary operator, the equality comparision is enough to get boolean value
